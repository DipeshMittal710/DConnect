...
import { Box, Button, Divider, IconButton, Snackbar, TextField, Typography } from "@mui/material";
    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: { xs: "8px", sm: "12px" } }}>
          <VideoCallIcon sx={{ fontSize: { xs: 26, sm: 34, md: 40 }, color: "#ff9839" }} />
          <h2 style={{ margin: 0, fontWeight: 700, fontSize: "clamp(1rem, 2.5vw, 1.35rem)" }}>
            DConnect
          </h2>
        </Box>

        <Box sx={{ display: "flex", alignItems: "center", gap: { xs: "8px", sm: "18px" } }}>
          <Button
        ...
        <Box sx={{ flex: 1, maxWidth: { xs: "100%", lg: "580px" } }}>
          <h1 style={{ marginBottom: "15px" }}>
            <Box component="span" sx={{
              display: "block",
              fontSize: { xs: "clamp(1.5rem, 7vw, 2rem)", sm: "2.4rem", md: "3rem", lg: "3.4rem" },
          ...
          <Box sx={{
            ...
            padding: { xs: "20px 16px", sm: "24px 20px", md: "28px", lg: "30px" },
            ...
            <Divider sx={{ borderColor: "rgba(255,255,255,0.12)", mb: 2.5 }}>
              <Typography sx={{ color: "rgba(255,255,255,0.4)", fontSize: "0.78rem", px: 1 }}>
                or join an existing meeting
              </Typography>
            </Divider>

            <h3 style={{ marginBottom: "20px", fontWeight: 600, fontSize: "1rem" }}>
              Join a Meeting
            </h3>
